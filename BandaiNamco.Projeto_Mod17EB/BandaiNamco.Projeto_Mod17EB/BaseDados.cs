...
namespace WebNavarro
{
    class BaseDados
    {
            ...
            public BaseDados()
            {
                ...
                strLigacao = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ESEN\source\repos\BandaiNamco.Projeto_Mod17EB\BandaiNamco.Projeto_Mod17EB\Data_App\DB_Bandai_Namco.mdf;Integrated Security=True;Connect Timeout=30";
            ...
            // Metodo para devolver o resultado de uma consulta de SQL(Query) com parametros 
